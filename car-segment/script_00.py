...
def split_train_valid_list():
    ...
    shortnames = [x.split('.')[0].replace('train512x512/','')[:-3] for x in names]
    ...
    #make train, valid
    file1 = CARVANA_DIR +'/split/'+ 'train512x512_v0_%d'%(num_train*CARVANA_NUM_VIEWS)
    file2 = CARVANA_DIR +'/split/'+ 'valid512x512_v0_%d'%(num_valid*CARVANA_NUM_VIEWS)
