...
def run_train():
    ...
    initial_checkpoint = '/home/chicm/ml/kgdata/kaggle-carvana-cars-2017/results_1024_3/checkpoint/007.pth'
    ...
    train_dataset = KgCarDataset(  'train1024x1024_v0_4848',
                                   #'train_5088',
                                   'train1024x1024', ## 1024x1024 ##
    ...
    valid_dataset = KgCarDataset('valid1024x1024_v0_240', 'train1024x1024', transform=[], mode='train')
